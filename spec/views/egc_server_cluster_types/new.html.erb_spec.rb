...
RSpec.describe "egc_server_cluster_types/new", type: :view do
  before(:each) do
    assign(:egc_server_cluster_type, EgcServerClusterType.new(
      :name => "MyString",
      :description => "MyText",
  ...
  it "renders new egc_server_cluster_type form" do
    render

    assert_select "form[action=?][method=?]", egc_server_cluster_types_path, "post" do
